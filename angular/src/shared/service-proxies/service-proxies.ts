...
export class TaskServiceProxy {
    ...
    private http: HttpClient;
    private baseUrl: string;
    private taskModel: TaskDto;
    constructor(@Inject(HttpClient) http: HttpClient, @Optional() @Inject(API_BASE_URL) baseUrl?: string) {
        this.http = http;
        this.baseUrl = baseUrl ? baseUrl : "";
    }

    getTasks(keyword?: string): Observable<TaskResponse> {
        let url_ = this.baseUrl + "/api/services/app/Task/GetTasks?";
        return this.http.get<TaskResponse>(url_);
    }
    getTaskSearch(keyword?: string): Observable<TaskResponse> {
        let url_ = this.baseUrl + "/api/services/app/Task/GetTasks?";
    ...
    // getTaskForEdit(id: number | undefined): Observable<GetRoleForEditOutput> {
    //     let url_ = this.baseUrl + "/api/services/app/Task/GetRoleForEdit?";
    //     if (id === null)
    //         throw new Error("The parameter 'id' cannot be null.");
    //     else if (id !== undefined)
    //         url_ += "Id=" + encodeURIComponent("" + id) + "&";
    ...
    create(body: CreateTaskDto | undefined){
     ...
     return this.http.post<CreateTaskDto>(url_, content_, options_);
    }

    updateTask(body: EditTaskDto | undefined) {
        ...
        return this.http.put<EditTaskDto>(url_, content_, options_);
    }
